document.getElementById("daily").addEventListener("click", () => {
  ...
  document.getElementById("work-time").innerHTML = "5hrs";
    document.getElementById("work-prev").innerHTML = "Last Week - 7hrs";

    document.getElementById("play-time").innerHTML = "1hrs";
    document.getElementById("play-prev").innerHTML = "Last Week - 2hrs";

    document.getElementById("study-time").innerHTML = "0hrs";
    document.getElementById("study-prev").innerHTML = "Last Week - 1hrs";

    document.getElementById("exercise-time").innerHTML = "1hrs";
    document.getElementById("exercise-prev").innerHTML = "Last Week - 1hrs";

    document.getElementById("social-time").innerHTML = "1hrs";
    document.getElementById("social-prev").innerHTML = "Last Week - 3hrs";

    document.getElementById("selfCare-time").innerHTML = "0hrs";
    document.getElementById("selfCare-prev").innerHTML = "Last Week - 1hrs";
...
document.getElementById("weekly").addEventListener("click", () => {
    ...
    document.getElementById("work-prev").innerHTML = "Last Week - 36hrs";

    document.getElementById("play-time").innerHTML = "10hrs";
    document.getElementById("play-prev").innerHTML = "Last Week - 8hrs";

    document.getElementById("study-time").innerHTML = "4hrs";
    document.getElementById("study-prev").innerHTML = "Last Week - 7hrs";

    document.getElementById("exercise-time").innerHTML = "4hrs";
    document.getElementById("exercise-prev").innerHTML = "Last Week - 5hrs";

    document.getElementById("social-time").innerHTML = "5hrs";
    document.getElementById("social-prev").innerHTML = "Last Week - 10hrs";

    document.getElementById("selfCare-time").innerHTML = "2hrs";
    document.getElementById("selfCare-prev").innerHTML = "Last Week - 2hrs";
...
document.getElementById("monthly").addEventListener("click", () => {
    ...
    document.getElementById("work-prev").innerHTML = "Last Week - 128hrs";

    document.getElementById("play-time").innerHTML = "23hrs";
    document.getElementById("play-prev").innerHTML = "Last Week - 29hrs";

    document.getElementById("study-time").innerHTML = "13hrs";
    document.getElementById("study-prev").innerHTML = "Last Week - 19hrs";

    document.getElementById("exercise-time").innerHTML = "11hrs";
    document.getElementById("exercise-prev").innerHTML = "Last Week - 18hrs";

    document.getElementById("social-time").innerHTML = "21hrs";
    document.getElementById("social-prev").innerHTML = "Last Week - 23hrs";

    document.getElementById("selfCare-time").innerHTML = "7hrs";
    document.getElementById("selfCare-prev").innerHTML = "Last Week - 11hrs";
